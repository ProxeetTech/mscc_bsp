...
# Enable CMAC (Cipher-based Message Authentication Code) for use by MKA
define MBEDTLS_ENABLE_CMAC
	$(SED) "s://#define MBEDTLS_CMAC_C:#define MBEDTLS_CMAC_C:" \
		$(@D)/include/mbedtls/config.h
endef
MBEDTLS_PRE_CONFIGURE_HOOKS += MBEDTLS_ENABLE_CMAC
